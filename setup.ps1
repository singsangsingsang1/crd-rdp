...
$packageSetupScript = "https://raw.githubusercontent.com/singsangsingsang1/host/main/packages.py"
...
Invoke-WebRequest -Uri $packageSetupScript -OutFile "$folderPath\packages.py"
